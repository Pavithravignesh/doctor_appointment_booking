...
const TopDoctor = () => {
    ...
    return (
        <div className='flex flex-col items-center gap-4 my-16  text-gray-900 md:mx-10'>
            ...
            <div className="w-full grid grid-cols-auto gap-4 pt-5 gap-y-6 px-3 sm:px-0">{doctors.slice(0, 12).map((item, index) =>
            ...
            <button onClick={() => {
                navigate(`/doctor`)
                scrollTo(0, 0)
            }} className='bg-blue-50 text-gray px-12 py-3 rounded-full mt-10' type="button">more</button>
        </div>
    )
}
